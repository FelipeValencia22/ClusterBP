    ...
    */
    ...
    public void saveRol(Rol entity) throws Exception {
        ...
        try {
            ...
            if (getRol(entity.getRolCodigo()) != null) {
    ...
    public void deleteRol(Rol entity) throws Exception {
        ...
        try {
            usuarioRols = usuarioRolDAO.findByProperty("rol.rolCodigo",
                    entity.getRolCodigo());

            if (Utilities.validationsList(usuarioRols) == true) {
                throw new ZMessManager().new DeletingException("usuarioRols");
            }
    ...
    public List<RolDTO> getDataRol() throws Exception {
        try {
            ...
            for (Rol rolTmp : rol) {
                ...
                rolDTO2.setRolCodigo(rolTmp.getRolCodigo());
                rolDTO2.setActivo((rolTmp.getActivo() != null)
                    ? rolTmp.getActivo() : null);
                rolDTO2.setFechaCreacion(rolTmp.getFechaCreacion());
                rolDTO2.setFechaModificacion(rolTmp.getFechaModificacion());
                rolDTO2.setNombre((rolTmp.getNombre() != null)
                    ? rolTmp.getNombre() : null);
                rolDTO2.setUsuCreador((rolTmp.getUsuCreador() != null)
                    ? rolTmp.getUsuCreador() : null);
                rolDTO2.setUsuarioModificador((rolTmp.getUsuarioModificador() != null)
                    ? rolTmp.getUsuarioModificador() : null);
                rolDTO.add(rolDTO2);
            }
    ...
    public Rol getRol(Long rolCodigo) throws Exception {
        ...
        try {
            entity = rolDAO.findById(rolCodigo);
        } catch (Exception e) {
