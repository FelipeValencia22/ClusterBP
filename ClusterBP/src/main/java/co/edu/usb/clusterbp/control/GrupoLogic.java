...
public class GrupoLogic implements IGrupoLogic {
	...
	public void saveGrupo(Grupo entity) throws Exception {
		...
		try {
			...
			log.debug("save Grupo successful");
		} catch (Exception e) {
	...
	public void deleteGrupo(Grupo entity) throws Exception {
		...
		if (entity.getGrupoCodigo() == null) {
			throw new ZMessManager().new EmptyFieldException("grupoCodigo");
		}
		...
		try {
			grupoRepositorios = grupoRepositorioDAO.findByProperty("grupo.grupoCodigo",
					entity.getGrupoCodigo());
			...
			grupoUsuarios = grupoUsuarioDAO.findByProperty("grupo.grupoCodigo",
					entity.getGrupoCodigo());
	...
	public Grupo getGrupo(Long grupoCodigo) throws Exception {
		...
		try {
			entity = grupoDAO.findById(grupoCodigo);
		} catch (Exception e) {
	...
	public String consultarGrupoPorNombre(String nombre) {
		return grupoDAO.consultarGrupoPorNombre(nombre);
	}
}
