    ...
    */
    ...
    public void saveUsuario(Usuario entity) throws Exception {
        ...
        try {
            ...
            if (getUsuario(entity.getUsuarioCodigo()) != null) {
    ...
    public List<UsuarioDTO> getDataUsuario() throws Exception {
        try {
            ...
            for (Usuario usuarioTmp : usuario) {
                ...
                usuarioDTO2.setActivo((usuarioTmp.getActivo() != null)
                    ? usuarioTmp.getActivo() : null);
    ...
    public Usuario getUsuario(Long usuarioCodigo) throws Exception {
        ...
        try {
            entity = usuarioDAO.findById(usuarioCodigo);
        } catch (Exception e) {
